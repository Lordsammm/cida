...
from cida.models import ControlResponse, Finding, OrgProfile, QuestionnaireResponses
from cida.scoring.engine import score_organization

CASES_DIR = Path(__file__).parent.parent.parent / "tests" / "backtest" / "cases"
...
def _build_responses(org_id: str, raw_responses: list[dict]) -> QuestionnaireResponses:
    ...
    from cida.ingest.questionnaire import _score_response

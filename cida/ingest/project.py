...
from cida.models import Finding, OrgProfile, QuestionnaireResponses
from cida.ingest.sniffer import (
...
def _load_findings_from_paths(
    ...
    """
    from cida.ingest.sniffer import sniff, format_unknown_diagnostic
        ...
        try:
            if cat == "cspm_aws":
                ...
                if p.suffix.lower() in (".xml", ".nessus", ".csv"):
                    from cida.ingest.nessus import parse_nessus
                ...
                from cida.ingest.dmarc import parse_dmarc
                ...
                from cida.ingest.findings import _load_json_findings
...
def _parse_generic_vuln_json(path: Path) -> list[Finding]:
    ...
    from cida.models import Severity
    _SEV_MAP = {
    ...
    for item in items:
        ...
        try:
            from cida.models import Finding, Severity
